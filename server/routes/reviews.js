...
// POST /api/reviews/:recipeId - leave or update a rating + comment for a recipe
router.post('/:recipeId', requireAuth, (req, res) => {
  ...
  // One review per user per recipe: update it if it already exists, otherwise insert.
  const existing = db
...
// DELETE /api/reviews/:recipeId - remove your own review
